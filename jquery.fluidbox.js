			...
			fbClickHandler = function(e) {
				...
				if ($(this).hasClass('fluidbox')) {
					...
					if ($(this).data('fluidbox-state') === 0 || !$(this).data('fluidbox-state')) {
						...
						$activeFb.parents().andSelf().each(function() {
							if ($(this).css('perspective')) {
								$(this).css('perspective', 'none').addClass('fluidbox-cleanup');
							}

							if ($(this).css('transform') !== 'none') {
								$(this).css('transform', 'none').addClass('fluidbox-cleanup');
							}
